...
import 'package:first/views/storage_image_view.dart';
...
class PhotoGalleryView extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GridView.count(crossAxisCount: 2, padding: const EdgeInsets.all(8), mainAxisSpacing: 20, crossAxisSpacing: 20, 
